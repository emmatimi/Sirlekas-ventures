...
const EMAILJS_SERVICE_ID = process.env.VITE_EMAILJS_SERVICE_ID || "service_sirlekas";
const EMAILJS_RECEIPT_TEMPLATE_ID = process.env.VITE_EMAILJS_TEMPLATE_ID || "template_receipt";
const EMAILJS_RESET_TEMPLATE_ID = "template_reset_password";
const EMAILJS_PUBLIC_KEY = process.env.VITE_EMAILJS_PUBLIC_KEY || "user_placeholder_key";
